...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-n202oau.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-n202oau.containers.anotherwebservice.com/
...
```
git clone git@github.com:Samarth-8836/container-n202oau.git
cd container-n202oau
```
...
```
docker attach container-n202oau
```
